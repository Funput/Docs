...
:::info
Đây là gói **binary**, link vào thư viện Arch tại thời điểm dựng. Arch cập nhật liên tục, nên sau một đợt bump soname lớn (fcitx5, ibus, gtk4) gói có thể phải đợi bản phát hành kế tiếp. Muốn build từ mã nguồn trên máy mình thì dùng AUR khi kênh đó mở.
:::
